...
I'm a **Full Stack AI Engineer** from Egypt 🇪🇬 building production-grade **RAG pipelines**, **LLM-powered apps**, and **Arabic OCR/NLP** systems.

```bash
$ whoami
Mohamed Kandil — Full Stack AI Engineer

$ build
RAG engines • Arabic OCR pipelines • FastAPI backends
Vector search (Qdrant/pgvector) • Eval & observability

$ currently_building
LMS platform • Egyptian ID OCR • Hybrid RAG starters • Quranic knowledge base

$ ask_me_about
FastAPI • Qdrant • hybrid search • reranking • Arabic OCR post-processing
```
...
If you're building an AI product and want it to be **reliable in production**, I can help with:

| Area | What I bring |
|---|---|
| 🔍 RAG Systems | Hybrid retrieval · reranking · eval · citations · observability |
| 🪪 Arabic OCR | Detection → OCR → validation → structured JSON |
| ⚙️ Backend | FastAPI · clean architecture · Docker · CI · cloud storage |
| 🌐 Multilingual AI | Arabic-first NLP · multilingual embeddings · post-processing |

📬 **Reach me:** [mohamedkandeal7@gmail.com](mailto:mohamedkandeal7@gmail.com) — or ping me on [LinkedIn](https://linkedin.com/in/mohamed-kandil-97k)
...
|---|---|---|
| 🎓 [LMS Backend](https://github.com/Kandil7/lms_backend) | Learning Management System API | FastAPI · MongoDB · Azure Blob |
| 🪪 [Egyptian ID OCR](https://github.com/Kandil7/egyption_id_ready) | Arabic OCR for Egyptian national IDs | YOLO · PaddleOCR · EasyOCR |
| 🤖 [Mini RAG](https://github.com/Kandil7/mini-rag) | Minimal RAG engine for document Q&A | Python · Qdrant · LLM APIs |
| 🔀 [Hybrid RAG Starter](https://github.com/Kandil7/hybrid-rag-starter) | Hybrid search RAG template | Python · Vector DB · BM25 |
| 🤖 [AI Mastery 2026](https://github.com/Kandil7/AI-Mastery-2026) | Structured AI/ML learning journey | Jupyter · PyTorch · Transformers |
...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=kandil7&theme=tokyonight&no-frame=true&no-bg=true&margin-w=4&row=1" />
</div>
